...
export default class SeqCompCheckExplanations extends Sequence {
  ...
  constructor(props: any) {
    super(props);
    this.state = mapToObject(props.explanations, (e: Explanation) => [e.stringify(), null]);
  ...
  render(): JSX.Element {
    return <div>
      ...
      <br/>
      <p>
        Which of the following explanations could the robot give based on what happened?
      </p>
      <br/>
      {_.map(this.props.explanations, (e: Explanation, idx: number) => {
        let question = e.stringify();
